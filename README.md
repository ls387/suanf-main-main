...
| 文档                              | 适用人群  | 内容概览       |
| --------------------------------- | --------- | -------------- |
| [快速开始](docs/QUICK_START.md)   | ⭐ 所有人 | 5分钟快速上手  |
| [系统设计](docs/SYSTEM_DESIGN.md) | 🔧 开发者 | 算法和系统架构 |

### 📖 详细指南

| 文档                                   | 适用场景     | 关键内容                         |
| -------------------------------------- | ------------ | -------------------------------- |
| [参数调优](docs/PARAMETER_TUNING.md)   | 优化排课效果 | 种群大小、迭代次数、核心参数详解 |
| [工具使用](docs/TOOLS_USAGE.md)        | 分析和调试   | 5大工具的详细用法                |
| [数据库设置](docs/DATABASE_SETUP.md)   | 初始化系统   | 表结构、数据加载、SQL操作        |
| [优化指南](docs/OPTIMIZATION_GUIDE.md) | 提高成功率   | 容量优化、约束分析、性能调整     |

### 🔧 故障排除 & 技术参考

| 文档                                     | 适用情况     | 包含内容                         |
| ---------------------------------------- | ------------ | -------------------------------- |
| [常见问题](docs/TROUBLESHOOTING.md)      | 遇到问题时   | 8+ 常见问题和解决方案            |
| [修复报告](docs/REPAIR_REPORTS.md)       | 了解历史修复 | 周次支持修复、技术细节、验证方法 |
| [技术参考](docs/TECHNICAL_REFERENCES.md) | 深入理解系统 | 时间重叠检测、优化原理、调试技巧 |
...
以下文件已被整合到新的 `docs/` 目录，留作参考：

- `排课系统说明.md` → 参考 [系统设计](docs/SYSTEM_DESIGN.md) 和 [工具使用](docs/TOOLS_USAGE.md)
- `排课问题诊断与解决方案.md` → 参考 [常见问题](docs/TROUBLESHOOTING.md)
